...
export const RnApi = ['AccessibilityInfo', 'Alert', 'Animated', 'AppState', 'Notification', 'AsyncStorage', 'CameraRoll', 'Clipboard', 'DatePickerAndroid', 'Dimensions', 'Geolocation', 'ImageEditor', 'Keyboard', 'LayoutAnimation', 'Linking']
